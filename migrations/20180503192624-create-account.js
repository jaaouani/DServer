...
module.exports = {
  up: (queryInterface, _sequelize) => { return queryInterface.createTable('Accounts', {
      ...
      address: { type: _sequelize.STRING, allowNull: true, defaultValue: '' }, address2: { type: _sequelize.STRING, allowNull: true, defaultValue: '' }, phone: { type: _sequelize.STRING, allowNull: true, defaultValue: '' },
    });
  },
